...
use crate::trie_node::{NODE_ITER_FINISHED, TaggedNodeRef, TrieNodeODRc};
use crate::utils::debug::{PathRenderMode, render_debug_path};
use crate::zipper::*;
...
fn build_ascii_graph_logical<
    V: TrieValue + Debug,
    A: Allocator,
    Z: ZipperInfallibleSubtries<V, A> + ZipperMoving + ZipperIteration + ZipperValues<V>,
>(
    mut z: Z,
    dc: &DrawConfig,
    ds: &mut DrawState,
...
mod test {
    ...
    fn fizzbuzz() {
        ...
        m3_zipper.graft_map(crate::utils::ints::gen_int_range::<(), 4, u32>(
            3,
            n as u32,
            3,
            (),
        ...
        m5_zipper.graft_map(crate::utils::ints::gen_int_range::<(), 4, u32>(
            5,
            n as u32,
            5,
            (),
        ...
        r_zipper.graft_map(crate::utils::ints::gen_int_range::<(), 4, u32>(
            1,
            n as u32,
            1,
            (),
