...
use crate::dense_byte_node::{test_bit_in_mask, CellByteNode, DenseByteNode};
use crate::ring::*;
use crate::tiny_node::TinyRefNode;
use crate::trie_node::*;
use crate::utils::{find_prefix_overlap, starts_with};
...
impl<V: Clone + Send + Sync> TrieNode<V> for BridgeNode<V> {
        ...
        V: Lattice,
    {
        ...
        match other.as_tagged() {
            ...
            TaggedNodeRef::EmptyNode(_) => TrieNodeODRc::new(self.clone()),
        }
    }
